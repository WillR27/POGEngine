...
#define PG_SCOPED_PROFILE(msg) ScopedProfile<Unit::Nanoseconds> scopedProfile(__FUNCTION__, __LINE__, msg)
//#define PG_SCOPED_PROFILE_NO_MSG() ScopedProfile<> scopedProfile(__FUNCTION__, __LINE__)

#define PG_START_SCOPED_PROFILE(msg) { ScopedProfile<Unit::Nanoseconds> scopedProfile(__FUNCTION__, __LINE__, msg)

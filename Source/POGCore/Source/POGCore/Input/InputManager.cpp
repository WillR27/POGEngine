...
namespace POG::Core
{
	...
	void InputManager::OnKeyEvent(RawKeyEvent& e)
	{
	...
	void InputManager::OnMouseMoveEvent(RawMouseMoveEvent& e)
	{
	...
	void InputManager::OnMouseButtonEvent(RawMouseButtonEvent& e)
	{
